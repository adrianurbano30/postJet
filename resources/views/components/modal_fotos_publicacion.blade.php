...
<div
    ...
    x-show="show"
    id="{{ $id }}"
    class="fixed inset-0 z-50 flex w-full h-auto items-center justify-center py-2  jetstream-modal sm:px-0"
    style="display: none;"
>
                                                {{--clases quitadas del div de arriba px-4 py-6  overflow-y-auto--}}
    <div x-show="show" class="fixed inset-0 transition-all transform" x-on:click="show = false" x-transition:enter="ease-out duration-300"
        ...
        <div class="absolute inset-0 h-screen w-full  bg-black opacity-25"></div>
    </div>
