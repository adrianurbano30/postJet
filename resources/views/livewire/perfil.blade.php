    ...
    <div x-data="{tab:'publicaciones'}" class="w-full border-2 rounded-md bg-white border-gray-900 p-2 my-2">
        ...
        <div class="border-2 border-gray-400 rounded-b-lg">
            ...
            <div class="p-2"
                ...
                <p>Tus amigos</p>
                <div class="text-justify p-2">
                    Lorem ipsum dolor de los putos de tus amigos sit amet consectetur adipisicing elit. Beatae, eius deserunt officia natus quaerat magni tempore obcaecati voluptatum in explicabo labore fugiat perspiciatis quia, voluptates, tenetur necessitatibus non suscipit perferendis?
